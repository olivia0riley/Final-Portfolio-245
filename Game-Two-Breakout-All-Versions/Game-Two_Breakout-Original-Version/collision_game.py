...
from ball_2d_novector import Ball
...
def run_game():
    ...
    ball1 = Ball (320,10+height/2, 20, 20, pygame.color.Color("darkmagenta"))
    box1 = Box(300,460,125,10) 
    box2 = Box(0,0,640,25)
    box3 = Box(0,25,640,25)
    box4 = Box(0,50,640,25)
    ...
    ball1.setVelocity(2.0,2.0)
    box2.setColor("pink")
    box3.setColor("yellow")
    box4.setColor("green")
