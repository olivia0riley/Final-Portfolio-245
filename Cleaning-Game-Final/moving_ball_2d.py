...
## Version: Fall 2011 
##
## This file defines a sprite based ball class that can move in two dimensions and
## can bounce off other balls. It can also bounce off the edges of the screen.
