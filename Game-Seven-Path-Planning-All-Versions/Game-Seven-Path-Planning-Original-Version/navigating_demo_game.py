...
def run_game():
    ...
    box1 = Box (random.randint(0,480),random.randint(0,600),10,10)
    box2 = Box (random.randint(0,480),random.randint(0,600),10,10)
    box3 = Box (random.randint(0,480),random.randint(0,600),10,10)
    box4 = Box (random.randint(0,480),random.randint(0,600),10,10)
    box5 = Box (random.randint(0,480),random.randint(0,600),10,10)
    box6 = Box (random.randint(0,480),random.randint(0,600),10,10)

    object_lst = []

    object_lst.append(box1)
    object_lst.append(box2)
    object_lst.append(box3)
    object_lst.append(box4)
    object_lst.append(box5)
    object_lst.append(box6)
##
    click = False
