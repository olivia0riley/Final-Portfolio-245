...
class GridWorld:
        ...
        def neighbors(self,p):
                ...
                coords = [north,south,east,west,northwest,northeast,southwest,southeast]
        ...
        def manhattan(self,startp,endp):
                ...
                # Not any different from regular distance because of the squaring within the equation
                ...
                return math.sqrt(pow(end_p_x,2) + pow(end_p_y,2))
